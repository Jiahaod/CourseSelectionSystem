...
public class SelectTeacher extends JPanel implements ActionListener{
	...
	public SelectTeacher (){
		...
		selectTeacher = new JButton("查找教师信息");
	...
	public void actionPerformed(ActionEvent c){
		...
		if(obj == selectTeacher){
			...
			else
			{
				...
				{
					teacher = teacherDaolmp.ReturnTeacherInformation(Tid.getText());
					course = teacherDaolmp.TeacherfindCourseById(Tid.getText());
				}
				else
				{
					JOptionPane.showMessageDialog(this, "该工号不存在！");	
				}
			}
		}
		try
		{
			K = new SelectTeacherUI(teacher, course);
